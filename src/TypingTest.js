...
export default TypingTest;    // Create downloadable file
      ...
      {isLoading ? (
        ...
        <>
          ...
          {testCompleted && (
            ...
            </div>import React, { useState, useEffect, useRef, useCallback } from 'react';
...
const TypingTest = () => {
  ...
  // Function to scroll to the current flag
  const scrollToCurrentFlag = useCallback(() => {
    const currentFlag = document.getElementById("current-flag");
    if (currentFlag) {
      // Smooth scroll to the element
      currentFlag.scrollIntoView({ 
        behavior: 'smooth', 
        block: 'center'
      });
    }
